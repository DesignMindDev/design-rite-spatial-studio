...
/**
 * Process floorplan analysis as a background task
 * This function is called directly without HTTP overhead
 */
export async function processFloorplanAnalysis(projectId: string): Promise<void> {
  ...
  try {
    ...
    console.log(`[Analysis Worker] Completed successfully in ${executionTime}ms`);
